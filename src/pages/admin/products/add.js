...
const AddProduct = {
          ...
          <main class="h-full overflow-y-auto">
            <div class="container px-6 mx-auto grid">
              <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                <nav aria-label="Breadcrumb">
                  <ol role="list" class="max-w-2xl mx-auto flex items-center space-x-2 lg:max-w-7xl ">
                    ...
                    <li class="text-sm">
                      <a href="/#/admin/products/add" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">
                        Add
                      </a>
                    </li>
                  </ol>
              ...
              <div class="mt-5 md:mt-0 md:col-span-2">
                <div>
                  <form id="formAddProduct" class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                      <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-3">
                          <label for="name" class="block text-sm font-medium text-gray-700">Name</label>
                          <input type="text" name="name" id="name" autocomplete="given-name" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-3">
                          ...
                          <input type="text" name="price" id="price" autocomplete="given-name" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-3">
                          ...
                          <input type="text" name="discount" id="discount" autocomplete="given-name" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-3">
                          ...
                          <div id="select" class="group relative py-2 px-2 shadow-sm mt-1 block w-full border border-gray-300 rounded-md text-base after:content-[''] after:bg-transparent after:h-2 after:absolute after:w-full after:left-0 after:top-full">
                            <div id="select-value">Đồng hồ nam</div>
                      ...
                      <div>
                        ...
                        <div class="mt-1">
                          <textarea id="description" name="description" rows="3" class="py-2 px-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Description ..."></textarea>
                        </div>
                      </div>

                    </div>
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                      <button id="bton-addProduct" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Add Product
                      </button>
                    </div>
                  </form>
  ...
  afterRender() {
    ...
    document.getElementById("bton-addProduct").onclick = async (e) => {
      e.preventDefault()
